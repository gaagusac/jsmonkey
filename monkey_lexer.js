...
var monkey_lexer = (function () {
    var lexer = ({
        ...
        options: { "moduleName": "monkey_lexer" },
        performAction: function anonymous(yy, yy_, $avoiding_name_collisions, YY_START) {
            ...
            switch ($avoiding_name_collisions) {
                ...
                case 20: return 'RPAREN';
                    break;
                case 21: return 'LBRACE';
                    break;
                case 22: return 'RBRACE';
                    break;
        ...
        rules: [/^(?:fn\b)/, /^(?:let\b)/, /^(?:true\b)/, /^(?:false\b)/, /^(?:if\b)/, /^(?:else\b)/, /^(?:return\b)/, /^(?:==)/, /^(?:!=)/, /^(?:=)/, /^(?:\+)/, /^(?:-)/, /^(?:\*)/, /^(?:!)/, /^(?:\/)/, /^(?:<)/, /^(?:>)/, /^(?:,)/, /^(?:;)/, /^(?:\()/, /^(?:\))/, /^(?:\{)/, /^(?:\})/, /^(?:\[)/, /^(?:\])/, /^(?::)/, /^(?:\s+)/, /^(?:"[^\"]*")/, /^(?:([a-zA-Z_][a-zA-Z0-9_]*))/, /^(?:([0-9])+)/, /^(?:.)/, /^(?:$)/],
